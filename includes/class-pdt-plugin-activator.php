...
class RFM_Plugin_Activator {
	...
	public static function activate() {
         ...
         * Custom Post Types
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rfm-plugin-post_types.php';
        $plugin_post_types = new RFM_Plugin_Post_Types();
        ...
        /**
         * Create  order list view in Database
        */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/classes/class-rfm-database.php';
        RFM_Databse::get_instance()->create_view();

        /**
         * The class responsible for activate all of classes in this plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rfm-plugin-controller.php';
        RFM_Plugin_Controller::get_instance()->activate();

        // require_once( plugin_dir_path( dirname( __FILE__ ) ) . 'classes/class-rfm-aggregator.php' );

<?php
    ...
    */
        public function get_price_list() {
            $results =  PD_Shipping::get_instance()->get_shipping_list(array(
                'type'          => $_POST['type'],
    ...
    */
        public function save_shipping() {
             $shipping =  new PD_Shipping( array(
        ...
        $result = PD_Shipping::get_instance()->clear_shipping_cost();

        die( json_encode( $result ) );
        }

        public function clear_all_wage_cost(){
             $result = PD_Shipping::get_instance()->clear_all_wage_cost();
        die( json_encode( $result ) );
        }
        public function clear_all_other_cost(){
            $result = PD_Shipping::get_instance()->clear_all_other_cost();
        die( json_encode( $result ) );
        }
    }
    ...
    public function update_woocommerce_product () {
        ...
        if($save_type == 'array'):
            foreach($products as $product):
                $created_product = new CreatedProduct([
                    'type' => $product_type ,
                    'o_price' => $product['_o_price'] ,
                    'n_price' => $product['_price'] ,
                    'sug_price' => $product['_sug_price'],
                    'pro_id' => $product['product_id']
                ]);
                
                $result = $created_product->save_info();
            endforeach;
        else:
            $created_product = new CreatedProduct([
                'type' => $product_type ,
                'o_price' => $_POST['_o_price'] ,
                'n_price' => $_POST['_price'] ,
                'sug_price' => $_POST['_sug_price'],
